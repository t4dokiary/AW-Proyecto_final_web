...
export class AdministradoresService {
  ...
  public validarAdmin(data: any, editar: boolean) {
    ...
    } else if (parseInt(data["edad"], 10) <= 17) {
      error["edad"]=this.errorService.required;
      alert("La edad debe ser mayor a 17 años");
    }
