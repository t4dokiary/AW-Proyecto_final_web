...
const session_cookie_name = 'aplicacion-dos-token';
const user_email_cookie_name = 'aplicacion-dos-email';
const user_id_cookie_name = 'aplicacion-dos-user_id';
const user_complete_name_cookie_name = 'aplicacion-dos-user_complete_name';
const group_name_cookie_name = 'aplicacion-dos-group_name';
const codigo_cookie_name = 'aplicacion-dos-codigo';
